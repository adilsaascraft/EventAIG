...
import roomCategoryData from '@/app/data/roomCategoryData'
...
export default function SupplierTable({ activeTab }: SuplierTableProps) {
  const [data, setData] = useState<Department[]>(roomCategoryData)
      ...
      {editItem && (
        <div className="fixed inset-0 flex justify-center items-center">
          <div className="bg-white p-6 rounded shadow-md w-96">
            <h2 className="text-lg font-bold mb-4">Edit Room Details</h2>
            <input
