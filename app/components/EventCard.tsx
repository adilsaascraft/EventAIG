    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col md:flex-row items-start md:items-center gap-4 relative">
      ...
      <div className="flex-1 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
          ...
          <span className="text-xs font-semibold bg-green-100 text-green-700 px-2 py-[2px] rounded w-fit">
            {event.status}
          </span>
        </div>
        ...
        <div className="mt-2 flex gap-6 text-sm text-gray-800">
          <div className="flex items-center gap-2">
            <User size={16} />
            {event.organizersCount} Organizer
          </div>
          <div className="flex items-center gap-2">
            <Users size={16} />
      ...
      {/* Manage + Dropdown + Registration Link */}
        ...
        <div className="relative" ref={dropdownRef}>
          <div className="flex items-center border border-gray-200 rounded-md overflow-hidden divide-x bg-white hover:bg-gray-100">
            <button
              ...
              className="px-3 py-1 text-black text-sm hover:bg-gray-100"
            >
              Manage
            </button>
            <button
              onClick={() => setShowDropdown(!showDropdown)}
              className="px-2 text-gray-400 hover:bg-gray-100"
            >
