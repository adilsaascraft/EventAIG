...
type AddHotelFormProps = {
  onSave: (venue: HotelFormData & { id: number; status: string }) => void
}

export default function AddHotelForm({ onSave }: AddHotelFormProps) {
      ...
      <div className="flex flex-col h-screen bg-white">
        ...
        >
          <div>
            ...
            />
            {errors.hotelName && <p className="text-sm text-red-500">{errors.hotelName.message}</p>}
          </div>
