...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-3 font-medium", className)}
      {...props}
    />
  )
}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-size={size}
      className={cn(
        "flex items-center gap-2 rounded-md px-2 py-1 transition-colors w-full",
        size === "sm" ? "text-xs h-7" : "text-sm h-8",
        activeClasses,
        className
      )}
      {...props}
